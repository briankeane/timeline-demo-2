    ...
    <div class="spec-item d-flex justify-content-between">
        ...
        <div>Includes Gibson Accessory Kit</div>
                ...
                <div id="disclaimer" class="spec-section">
                    <p>
                        <small><i>In order to continually improve the design, quality and performance of our products and instruments and to make use of the best materials at all times, Gibson reserves the right to change specifications without notice.</i></small>
                    </p>
                </div>
            </div>
        </div>
